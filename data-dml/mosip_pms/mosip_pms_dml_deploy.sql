...
----- TRUNCATE pms.device_detail TABLE Data and It's reference Data and COPY Data from CSV file -----
...
----- TRUNCATE pms.secure_biometric_interface TABLE Data and It's reference Data and COPY Data from CSV file -----
...
----- TRUNCATE pms.secure_biometric_interface_h TABLE Data and It's reference Data and COPY Data from CSV file -----
